...
public class GameObject
{
	...
	*/
	...
	/** rotates this GameObject around the global y axis */
	public void globalYaw(float angle) {
		Vector3f worldPosition = this.getWorldLocation();
		Matrix4f rotation = new Matrix4f().rotationY(angle);
	
		Matrix4f newTransform = new Matrix4f().translate(worldPosition)
											 .mul(rotation)
											 .translate(worldPosition.negate());
	
		this.setLocalRotation(newTransform.mul(this.getLocalRotation()));
	}
